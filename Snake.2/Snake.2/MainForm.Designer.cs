namespace Project___Snake
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            Player3StartButton = new Button();
            Player3ScoreLabel = new Label();
            ...
            PlayAgain.Margin = new Padding(2);
            ...
            // Player3StartButton
            // 
            Player3StartButton.Location = new Point(680, 202);
            Player3StartButton.Name = "Player3StartButton";
            Player3StartButton.Size = new Size(130, 71);
            Player3StartButton.TabIndex = 9;
            Player3StartButton.Text = "Player 3";
            Player3StartButton.UseVisualStyleBackColor = true;
            Player3StartButton.Click += Player3StartButton_Click;
            // 
            // Player3ScoreLabel
            // 
            Player3ScoreLabel.Location = new Point(680, 156);
            Player3ScoreLabel.Name = "Player3ScoreLabel";
            Player3ScoreLabel.Size = new Size(130, 71);
            Player3ScoreLabel.TabIndex = 10;
            Player3ScoreLabel.Text = "Player 3 Score : 0";
            Player3ScoreLabel.TextAlign = ContentAlignment.MiddleCenter;
            ...
            Controls.Add(Player3ScoreLabel);
            Controls.Add(Player3StartButton);
        ...
        private Button Player3StartButton;
